...
data = torch.load('/data1/longshen/Datasets/Piano/POP909/latents/bar_level_pos_seq/train_latents.pt')
...
z = data[0]  # [n_pos, 128]
print(z.shape)
decoded = model.decode_batch(z[-5:])
...
# save_dir = '/home/longshen/work/AccGen/AccGen/test_outputs/vae/pos_level/sample_from_normal/sample_and_interpolate/exp2'
# create_dir_if_not_exist(save_dir)
...
# mts = model.decode_batch(z_inter, return_mt=True)
# for i, mt in enumerate(mts):
