...
def main():
    ckpt_fp = '/data1/longshen/Results/AccGenResults/diffusion_prior_one_bar/6layer_vae_scaled/bs1280_lr1e-3_ep1000/tb_logs/version_0/checkpoints/last.ckpt'
    ...
    x = torch.randn(10, 4, 512).to(device)
    ...
    ae = MQVAE().to(device)
    with torch.no_grad():
        out = ae.decode_batch(x, return_mt=True, scale_factor=0.3428)  # scale back

    out_dir = "/home/longshen/work/AccGen/AccGen/test_outputs/diffuse_one_bar/output_vae_scaled_loss0.092"
